<!DOCTYPE html>
<html xmlns="https://www.w3.org/1999/xhtml" <?php language_attributes(); ?>> <!-- profile="http://gmpg.org/xfn/11"/ -->
<head>
...
<li><a href="https://ma.ellak.gr/overview/"><?php _e('ΔΡΑΣΕΙΣ','ma-ellak');?></a></li>
         ...
         <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <?php }?>
                <li><a href="https://ma.ellak.gr/%CE%B5%CE%BD%CE%B7%CE%BC%CE%B5%CF%81%CF%89%CF%84%CE%B9%CE%BA%CE%AC-%CE%B4%CE%B5%CE%BB%CF%84%CE%AF%CE%B1-%CE%BC%CE%BF%CE%BD%CE%AC%CE%B4%CF%89%CE%BD-%CE%B1%CF%81%CE%B9%CF%83%CF%84%CE%B5%CE%AF%CE%B1/"><?php _e('Ενημερωικά Δελτία','ma-ellak');?></a></li>
	...
	<?php		}?>
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a target="_blank" href="https://ma.ellak.gr/edu"><?php _e('ΤΗΛΕΚΠΑΙΔΕΥΣΗ','ma-ellak');?></a></li>


				<li><a target="_blak" href="https://ma.ellak.gr/forge"><?php _e('ΑΝΑΠΤΥΞΗ ΕΡΓΩΝ','ma-ellak');?></a></li>


				<li><a href="https://ma.ellak.gr/manuals/"><?php _e('ΟΔΗΓΙΕΣ ΧΡΗΣΗΣ','ma-ellak');?></a></li>
